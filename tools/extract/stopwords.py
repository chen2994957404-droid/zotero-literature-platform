...
来源：Glasgow Information Retrieval Group 的 stop word list，即 scikit-learn
`sklearn.feature_extraction.text.ENGLISH_STOP_WORDS`（318 词）。2026-09-24 从 scikit-learn 原样导出。

**为什么收一份而不是 import**：主力机没装 scikit-learn，为一张词表装整个机器学习库不值得；
