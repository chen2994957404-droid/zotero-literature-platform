...
用法: python core/proc_lock/selftest.py
"""
import sys, os, io
...
from core.proc_lock import single_instance, release, holder, _lock_path
from core.subproc import run as _run
...
def main():
    ...
    code = (f"from core.proc_lock import single_instance;"
