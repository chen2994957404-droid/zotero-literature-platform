...
- [WARN] 公理件自测: 14/18 自测通过（共 19 个公理件）；跳过慢测试 ['chart_digitize']（--full 可跑）；失败: ['embed', 'llm_client', 'zotero_client', 'query_expand']
...
- `docs/踩坑记录.md`（63 KB） — 所有踩过的坑，含根因与解法
- `docs/变更记录.md`（108 KB） — 每次改动的来龙去脉
