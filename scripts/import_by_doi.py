...
# 要导入的文献：DOI -> 标签
TARGETS = [
    # 第二批：B-N 配位机理 + PBS 共混/复合 + 硼酸酯交换动力学
    ("10.1038/s41467-026-73149-2",     ["待精读", "B-N配位"]),
    ("10.1016/j.polymer.2022.125200",  ["待精读", "B-N配位"]),
    ("10.1021/acspolymersau.2c00046",  ["待精读", "B-N配位"]),
    ("10.1016/j.polymer.2022.125013",  ["待精读", "PBS共混相容性"]),
    ("10.1016/j.eurpolymj.2026.114615", ["待精读", "PBS共混相容性"]),
    ("10.3390/polym14224824",          ["待精读", "PBS机理"]),
    ("10.1021/acsmaterialsau.3c00074", ["待精读", "硼酸酯交换"]),
    ("10.3390/polym14040842",          ["待精读", "硼酸酯交换"]),
    ("10.1039/d3py01047c",             ["待精读", "硼酸酯交换"]),
]
