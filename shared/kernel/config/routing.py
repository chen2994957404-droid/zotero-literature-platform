...
PURPOSES = {
    'DEEPREAD':       {'label': '精读',           'setting': 'DEEPREAD_MODEL',
                       ...
                       'local': ('ok', '本地 qwen3.5（9.7B）金标 40 篇均分 90.6、0 编数（2026-09-15 实测）；'
                                       ...
                                       '云端同批对照还没跑，差多少不知道')},
    'REVIEW':         {'label': '精读审稿',       'setting': 'REVIEW_MODEL',
                       'needs': ['text', 'json'],
                       'local': ('ok', '逐句判「原文支不支持」，输入几千字英文材料 + 二十几句中文，输出小 JSON。'
                                       '用户 2026-09-20 定：默认本地（云端校准 5 篇花 1.5 元，按篇乘负荷不起）。'
                                       '本地校准数字见 docs/变更记录.md 的「审稿校准」条目')},
