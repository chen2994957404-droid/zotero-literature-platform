...
用法: python shared/kernel/config/selftest.py
"""
...
from shared.kernel.config import (get_key, all_keys, ENV_FILE, keyring_status,
...
def main():
    ...
    total += 1
    from shared.kernel.config import env_shadow
    ...
    if avail:
        ...
        try:
            from shared.kernel import config as C
