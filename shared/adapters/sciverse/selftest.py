...
用法: python shared/adapters/sciverse/selftest.py
"""
import sys, os, io
...
from shared.adapters.sciverse import clean_chunk, _year, available, paper_relations, SciverseError
...
def main():
    ...
    if not available():
        ...
        try:
            from shared.adapters.sciverse import search_papers
